...
$mheading='<center><H3> Section wise Contract Laboutr Engagement for the Period from  '.$Sdate.' To '. $Todate.'- Vendor -'.$mvendor.' - Cost center '.$mcostcenter.'</h3></center>';
...
$md="update tempt5 set crnam='' where substr(crnam,1,4)='xxxx' ";
		$result = DB_query($md,$db);
$md="update tempt5 set costcenter='' where substr(costcenter,1,4)='xxxx' ";
		$result = DB_query($md,$db);
...
$md="insert into tempt5(section,ashifteng,bshifteng,cshifteng,totaleng) select section,ashifteng,bshifteng,cshifteng,totaleng from tempt6  ";
		$result = DB_query($md,$db);
$md="select section,ashifteng,bshifteng,cshifteng,totaleng,crnam,aprnam  from tempt5 " ;
//$md="select a.lastname as'Employee Name', b.* from prlemployeemaster a, tmon b where a.employeeid=b.employeeid"; 
 ...
 $md="select Section ,Ashifteng,Bshifteng,Cshifteng,Totaleng,crnam as 'Section Incharge',aprnam as'Plant Incharge' from tempt5 " ;
