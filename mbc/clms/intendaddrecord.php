...
//echo "RRRRRRRR".$EmployeeID; 
 ...
 $sql = "SELECT vendor,section,stdate,endate,ashift,bshift,cshift,urgent from clmsintend where trim(vendor) like '".$mvendor."%' and trim(section) like '".$msection."%' and trim(stdate)='".$mstdate."'";
	$ErrMsg = _('The employee master could not be retrieved because'); 
//echo $sql;	
...
//	echo "<FORM METHOD='post' action='" . $_SERVER['PHP_SELF'] . '?' . SID ."'>";  
	echo "<FORM METHOD='post' action='intendaddrecord1.php'>";  
...
*/
  if ($myrow09[0] <> 'ADMIN'){
    ...
    echo '</table>';
	echo"<P><CENTER><INPUT TYPE='Submit' NAME='submit' VALUE='" . _('Update Intend') . "'>";
	echo'</FORM>';
?>