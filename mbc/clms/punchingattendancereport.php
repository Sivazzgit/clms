...
if($_SESSION['UserID']=='clmsadmin'){
	//$kkdept='ALL';
			...
			$sql = "create temporary table tmp SELECT employeeid,lastname FROM clmsemployeemaster where employeeid>70000 and employeeid<80000  and dept like '".$kkdept."%'";
...
$sql = "select  dt as'Date',DAYNAME(STR_TO_DATE(dt,'%d-%m-%Y')) as'wkday' ,sshift as'Sch Shift',inpunch,outpunch,
Workcenter as'Shift Incharge',Shift,Type,HRS,Section as 'Working Section' from tpatt1 order by dt"; 
