...
*/
echo '<center><a href="billingmonthly.php">' . _('Monthly Billing Details') . '</a><BR>'; 
echo '<center><a href="prlSelectEmployee.php">' . _('Add/Update Employee Details') . '</a><BR>';
echo '<center><a href="intend.php">' . _('Intend View') . '</a><BR>';
echo '<center><a href="manpowerentryapprovalstatus.php">' . _('Contract Labour Engagement Approval Status') . '</a><BR>';
echo '<center><a href="mustrolattendance1.php">' . _('Mustrol View') . '</a><BR>';
echo '<center><a href="uploadshiftroster.php">' . _('Shift Roster Upload') . '</a><BR>';
echo '<center><a href="shiftrosterview.php">' . _('Shift Roster View') . '</a><BR>';
echo '<center><a href="PunchingDataUploadinpunch.php">' . _('Punching Data Upload-IN PUNCH') . '</a><BR>';
echo '<center><a href="PunchingDataUploadoutpunch.php">' . _('Punching Data Upload-OUT PUNCH') . '</a><BR>';
echo '<center><a href="punchingview.php">' . _('Punching Data View') . '</a><BR>';
echo '<center><a href="punchingattendancereport.php">' . _('Attendance Card') . '</a><BR>';
...
if($mmonth1<>'0921'){
	$sql0="CREATE TABLE IF NOT EXISTS clmsmanpower".$mmonth1." LIKE  manpower0921" ;
...
//			$sql = "insert into clmspunching(column0,column3,dt,time0,column6) select employeeid,in_out,date,(trim(time)/1),time  FROM clmspunchingapi where  employeeid>10 and employeeid<200  and substr(trim(date),3,7)=substr(trim('".$Sdate."'),3,7)";
			$sql = "insert into clmspunching(column0,column2,column3,column6,dt,time0) select column0,column2,column3,column6,dt,time0  FROM clmspunchingupload where  column0>70000 and column0<80000  and (STR_TO_DATE(trim(dt),'%d-%m-%Y') >= STR_TO_DATE('".$Sdate."','%d-%m-%Y') )";
//echo $sql;
...
//			$sql = "update clmspunching a,clmsshiftroster".$mmonth1."  b  set a.column2=b.shift where trim(a.column0)=trim(b.employeeid) and trim(a.dt)=trim(b.dt)";  
		...
		//	$result = DB_query($sql,$db);
			...
			$sql = "update  clmspunching set column3='IN' where column2='1' and column5 >5.00 and column5<10.00  ";
			$result = DB_query($sql,$db);

			$sql = "update  clmspunching set column3='OUT' where column2='1' and column5 >15.00 and column5<18.00  ";
			$result = DB_query($sql,$db);
			
			$sql = "update  clmspunching set column3='IN' where column2='2' and column5 >12.00 and column5<22.00  "; 
			$result = DB_query($sql,$db);
			$sql = "update  clmspunching set column3='OUT' where column2='2' and column5 >23.00 and column5<27.00  ";
			$result = DB_query($sql,$db);

			$sql = "update  clmspunching set column3='IN' where column2='3' and column5 >21.00 and column5<26.00  ";
			$result = DB_query($sql,$db);
...
//echo $sql;	      
			...
			$sql = "update  clmspunching set column2='A' where column3='IN' and column5 >6.00     ";
			$result = DB_query($sql,$db);
			$sql = "update  clmspunching set column2='B' where column3='IN' and column5 >14.00     ";
			$result = DB_query($sql,$db);
			$sql = "update  clmspunching set column2='C' where column3='IN' and column5 >22.00     ";
			$result = DB_query($sql,$db);
			
			$sql = "update  clmspunching set column2='C' where column3='OUT' and column5 >23 and column5<33    ";
			$result = DB_query($sql,$db);
			$sql = "update  clmspunching set column2='B' where column3='OUT' and column5 >18.00 and column5 < 26    ";
			$result = DB_query($sql,$db);
			$sql = "update  clmspunching set column2='A' where column3='OUT' and column5 >14.00 and column5 < 18    ";
			$result = DB_query($sql,$db);
 ...
 */ 
			  $sql = "CREATE TEMPORARY TABLE TempT2 as (SELECT * ,00  as'slno',000.00 as'timeout','   ' as'sshift' FROM manpower0420 limit 0)";
			$result = DB_query($sql,$db);
...
$sql = "update tpatt set cinpunch=timein ";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
$sql = "update tpatt set cinpunch=7.00 where timein>6 and  timein <=7. ";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);

$sql = "update tpatt set cinpunch=8.00 where timein>7 and  timein <8 ";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
//$sql = "update tpatt set cinpunch=9.00 where timein>0 and  timein <9 and pshift =4";
//				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);

$sql = "update tpatt set cinpunch=16.00 where timein>14 and  timein <16 ";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
$sql = "update tpatt set cinpunch=24.00 where timein >23 ";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
...
$sql = "update tpatt set coutpunch=timeout ";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
$sql = "update tpatt set coutpunch=15.00 where timeout>15 and timeout <=16";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);

$sql = "update tpatt set coutpunch=16.00 where timeout>16 and timeout <18";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
...
$sql = "update tpatt set roundhrs=tchr "; 
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
$sql = "update tpatt set roundhrs=tchr+.15 where tcmin>15"; 
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
$sql = "update tpatt set roundhrs=tchr+.5 where tcmin>30";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
			
$sql = "update tpatt set roundhrs=tchr+.75 where tcmin>45";
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);

$sql = "update tpatt set roundhrs=0 where roundhrs<0"; 
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
				
$sql = "update tpatt set roundhrs=0 where roundhrs > 8"; 
				$result03 = DB_query($sql, $db, $ErrMsg, $DbgMsg);
