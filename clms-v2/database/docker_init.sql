-- ============================================================
-- CLMS 2.0 — Docker Init SQL
-- Auto-run by MySQL on first container startup.
-- Combines schema + role seed + default masters.
-- NOTE: Admin password is set to 'Admin@1234' by entrypoint.sh
--       via PHP password_hash() on first boot.
-- ============================================================
...
CREATE TABLE `companies` (
  ...
  `financial_year_start_month` TINYINT UNSIGNED DEFAULT 4,
...
-- FK added after sections table exists
...
('contractor',       'Contractor',               'Vendor portal'),
('section_incharge', 'Section In-charge',        'Raise indents, review deployments'),
('hod',              'HOD',                      'Review and approve'),
('plant_head',       'Plant Head / Factory Mgr', 'Final approval authority'),
('gate_staff',       'Gate / Security Staff',    'Record attendance');
...
-- Password placeholder — updated to 'Admin@1234' by docker-entrypoint.sh
-- ============================================================

INSERT INTO `users` (`company_id`, `username`, `password_hash`, `full_name`, `email`, `force_pwd_change`) VALUES
(1, 'clmsadmin', 'PLACEHOLDER', 'HR Administrator', 'admin@company.com', 1);
